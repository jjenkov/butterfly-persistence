...
public interface IObjectDao {
     ...
     * @throws PersistenceException If committing to the database fails.
     */
    public void commit() throws PersistenceException;

    /**
     * Calls rollback() on the underlying connection. Use this method to roll back (undo) a transaction.
     * @throws PersistenceException If rolling back the current transaction fails.
     */
     ...
     *                    the given object mapping. If no record/object was found by the given
     *                    primary key, null is returned.
     * @param <T>         The same type as the Class object passed in the objectMappingKey parameter.
     * @throws PersistenceException If reading the object by primary key fails.
     */
